...
<head>
  ...
  <title>Modify characteristics</title>
</head>
<body>
    <%
	jb.connect();
	int aux = java.lang.Integer.parseInt(request.getParameter("primarykey"));
	ResultSet rs = jb.returnLineFromId("characteristics", "idcharacteristics", aux);
	rs.first();
  ...
  <div class="py-5" style="	background-image: url(http://wallup.net/wp-content/uploads/2016/01/201862-animals-nature-horse.jpg);	background-position: top left;	background-size: 100%;	background-repeat: repeat;">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h1 class="text-light">Modify characteristics</h1>
        </div>
      </div>
    </div>
  </div>	  
  <div class="py-1" >
    <div class="container">
      <div class="row">
        <div class="col-md-12">        
          <form action="m2_characteristics.jsp" method="post">
          	<div class="form-group"> <label>Id</label> <input type="text" class="form-control" value="<%=aux%>" readonly name="idcharacteristics"></div>
            <div class="form-group"> <label>Name</label> <input type="text" class="form-control" placeholder="<%=Class%>" name="Class"> </div>
            <div class="form-group"> <label>Region</label> <input type="text" class="form-control" placeholder="<%=Orders%>" name = "Orders"> </div>
            <div class="form-group"> <label>Name</label> <input type="text" class="form-control" placeholder="<%=Species%>" name="Species"> </div>
            <div class="form-group"> <label>Name</label> <input type="text" class="form-control" placeholder="<%=Kingdom%>" name="Kingdom"> </div> 
            <button type="submit" class="btn btn-primary">Modify characteristics</button>
          </form>
          </div>
      </div>
    </div>
