...
<body>
  ...
  <div class="py-1">
    <div class="container">
      <div class="row">
        <div class="col-md-6"><a class="btn btn-primary" href="new_animals.jsp">Add animal</a></div>
        <div class="col-md-6"><a class="btn btn-primary" href="modify_animals.jsp">Modify Animal</a></div>
      </div>
    </div>
  </div>
  <div class="py-1">
    <div class="container">
      <div class="row">
        <div class="col-md-12" style="">
          ...
          <form action="delete_animals.jsp" method="post">
            <table class="table table-striped table-borderless">
              <thead>
                <tr>
                  <th scope="col">Mark</th>
                  <th scope="col" style="">IdAnimal</th>
            ...
            <%
			jb.connect();
			ResultSet rs = jb.returnTable("animals");
			long x;
			while (rs.next()) {
				x = rs.getInt("idanimals");
			%>
			<tr>
          ...
          <input class="btn btn-primary" type="submit" value="Delete marked animal">
          </form>
          </div>
        </div>
      </div>
