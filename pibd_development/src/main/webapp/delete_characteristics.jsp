...
<body>
	...
	<div class="py-5 bg-light"
		style="background-image: url(&quot;http://wallup.net/wp-content/uploads/2016/01/201862-animals-nature-horse.jpg&quot;); background-position: left top; background-size: 100%; background-repeat: repeat;">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
	...
	jb.connect();
	jb.deleteTableData(s, "characteristics", "idcharacteristics");
	jb.disconnect();
	%>
	<h1 align="center">
		<a href="table_characteristics.jsp"><b>Data was successfully deleted!</b></a> <br />
	</h1>
