...
<body>
  ...
  <div class="py-5 bg-light" style="background-image: url(&quot;http://wallup.net/wp-content/uploads/2016/01/136660-animals-bears-forest.jpg&quot;); background-position: left top; background-size: 100%; background-repeat: repeat;">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h1 class="text-white"><b>Animals characteristics database</b></h1>
        </div>
      </div>
    </div>
  </div>
  <div class="py-1">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6"><a class="btn btn-primary" href="modify_junction.jsp">Modify binding</a></div>
      </div>
    </div>
  </div>
  <div class="py-1">
    <div class="container">
      <div class="row">
        <div class="col-md-12" style="">
          ...
          <form action="delete_junction.jsp" method="post">
          ...
          <input class="btn btn-primary" type="submit" value="Delete marked bindings">
          </form>
          </div>
        </div>
      </div>
