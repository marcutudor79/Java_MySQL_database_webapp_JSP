...
<body>
    <%
	jb.connect();
	int aux = java.lang.Integer.parseInt(request.getParameter("idanimals"));
	String Name = request.getParameter("Name");
	String Region = request.getParameter("Region");
	String[] valori = { Name, Region };
	String[] campuri = { "Name", "Region" };
	jb.modifyTable("animals", "idanimals", aux, campuri, valori);
	jb.disconnect();
	%>
  ...
  <div class="py-1" >
    <div class="container">
      <div class="row">
        <div class="col-md-12">        
          <h1 align="center"><a href="table_animals.jsp">Modification was successful!</a></h1>
          </div>
      </div>
    </div>
  </div>
