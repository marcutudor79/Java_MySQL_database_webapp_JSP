...
<body>
    <%
	jb.connect();
	int aux = java.lang.Integer.parseInt(request.getParameter("idcharacteristics"));
	String Class = request.getParameter("Class");
	String Orders = request.getParameter("Orders");
	String Species = request.getParameter("Species");
	String Kingdom = request.getParameter("Kingdom");
	String[] valori = { Class, Orders, Species, Kingdom };
	String[] campuri = { "Class", "Orders", "Species", "Kingdom" };
	jb.modifyTable("characteristics", "idcharacteristics", aux, campuri, valori);
	jb.disconnect();
	%>
  ...
  <div class="py-1" >
    <div class="container">
      <div class="row">
        <div class="col-md-12">        
          <h1 align="center"><a href="table_characteristics.jsp">Modification was successful!</a></h1>
          </div>
      </div>
    </div>
  </div>
