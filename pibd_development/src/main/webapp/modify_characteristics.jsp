    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12" style="">
          ...
          <form action="m1_characteristics.jsp" method="post">
			...
			long x;
			while (rs.next()) {
				x = rs.getLong("idcharacteristics");
			%>
			<tr>
          ...
          <input class="btn btn-primary" type="submit" value="Modify marked characteristic">
          </form>
          </div>
        </div>
      </div>
