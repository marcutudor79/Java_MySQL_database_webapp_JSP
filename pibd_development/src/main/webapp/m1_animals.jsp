...
<body>
	...
	ResultSet rs = jb.returnLineFromId("animals", "idanimals", aux);
	rs.first();
  ...
  <div class="py-5" style="	background-image: url(https://cdn.wallpapersafari.com/19/43/DJHM7R.jpg);	background-position: top left;	background-size: 100%;	background-repeat: repeat;">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h1 class="text-light">Modify animal's region or name</h1>
        </div>
      </div>
    </div>
  </div>	  
  <div class="py-1" >
    <div class="container">
      <div class="row">
        <div class="col-md-12">        
          <form action="m2_animals.jsp" method="post">
          	<div class="form-group"> <label>Id</label> <input type="text" class="form-control" value="<%=aux%>" readonly name="idanimals"></div>
            <div class="form-group"> <label>Name</label> <input type="text" class="form-control" placeholder="<%=Name%>" name="Name"> </div>
            <div class="form-group"> <label>Region</label> <input type="text" class="form-control" placeholder="<%=Region%>" name = "Region"> </div> 
            <button type="submit" class="btn btn-primary">Modify animal</button>
          </form>
          </div>
      </div>
    </div>
