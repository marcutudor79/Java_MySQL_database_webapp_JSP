...
<body>
  ...
  <div class="py-1">
    <div class="container">
      <div class="row">
        <div class="col-md-6"><a class="btn btn-primary" href="new_characteristics.jsp">Add characteristics</a></div>
        <div class="col-md-6"><a class="btn btn-primary" href="modify_characteristics.jsp">Modify characteristics</a></div>
      </div>
    </div>
  </div>
  <div class="py-1">
    <div class="container">
      <div class="row">
        <div class="col-md-12" style="">
          ...
          <form action="delete_characteristics.jsp" method="post">
            ...
            <%
			jb.connect();
			ResultSet rs = jb.returnTable("characteristics");
			long x;
			while (rs.next()) {
				x = rs.getInt("idcharacteristics");
			%>
			<tr>
          ...
          <input class="btn btn-primary" type="submit" value="Delete marked characteristics">
          </form>
          </div>
        </div>
      </div>
