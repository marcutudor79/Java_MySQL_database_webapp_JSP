...
<body>
	...
	<div class="py-5 bg-light"
		style="background-image: url(&quot;https://cdn.wallpapersafari.com/19/43/DJHM7R.jpg&quot;); background-position: left top; background-size: 100%; background-repeat: repeat;">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
	...
	String[] s = request.getParameterValues("primarykey");
		jb.connect();
		jb.deleteTableData(s, "animals", "idanimals");
		jb.disconnect();
	%>
	<h1 align="center">
		<a href="table_animals.jsp"><b>Data was successfully deleted!</b></a> <br />
	</h1>
