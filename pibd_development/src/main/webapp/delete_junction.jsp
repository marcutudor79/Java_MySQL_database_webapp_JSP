...
<html>
<head>
<title>Database animals characteristics</title>
<meta charset="utf-8">
...
<body>
	...
	<div class="container">
		<a class="navbar-brand" href="#"><i
			class="fa d-inline fa-lg fa-bullseye"></i></a>
		...
		<div
			...
			<ul class="navbar-nav">
				<li class="nav-item"><a class="nav-link mx-2" href="index.html">Home</a>
				</li>
				<li class="nav-item"><a class="nav-link mx-2"
					href="table_animals.jsp">Animals database</a></li>
				<li class="nav-item"><a class="nav-link mx-2"
					href="table_characteristics.jsp">Characteristics database</a></li>
				<li class="nav-item"><a class="nav-link mx-2"
					href="table_junction.jsp">Animals characteristics database</a></li>
			</ul>
	...
	<div class="py-5 bg-light"
		style="background-image: url(&quot;http://wallup.net/wp-content/uploads/2016/01/136660-animals-bears-forest.jpg&quot;); background-position: left top; background-size: 100%; background-repeat: repeat;">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
	...
	jb.connect();
	jb.deleteTableData(s, "junction", "idjunction");
	jb.disconnect();
	%>
	<h1 align="center">
		<a href="table_junction.jsp"><b>Data was successfully deleted!</b></a> <br />
	</h1>
