...
<body>
  ...
  <div class="py-5" style="	background-image: url(https://cdn.wallpapersafari.com/19/43/DJHM7R.jpg);	background-position: top left;	background-size: 100%;	background-repeat: repeat;">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h1 class="text-light">Add animal to the database</h1>
        </div>
      </div>
    </div>
  </div>
	<h1><center><a href="table_animals.jsp"><b>Data was successfully added!</b></a> <br/></center></h1>	
	<%
	} else {
	%>
  <nav class="navbar navbar-expand-md navbar-dark bg-info">
  ...
  <div class="py-1" >
    <div class="container">
      <div class="row">
        <div class="col-md-12">        
          <form action="new_animals.jsp" method="post">
            <div class="form-group"> <label>Name</label> <input type="text" class="form-control" placeholder="Enter animal name" name="Name"> </div>
            <div class="form-group"> <label>Region</label> <input type="text" class="form-control" placeholder="Enter the region of the animal" name = "Region"> </div> 
